...
class Dumper
{
	...
	public static function renderAssets(): void
	{
		...
		$s = file_get_contents('/var/www/html/httpdocs/site/modules/TracyDebugger/tracy-2.10.x/src/Tracy/Dumper' . '/../assets/toggle.css')
			. file_get_contents('/var/www/html/httpdocs/site/modules/TracyDebugger/tracy-2.10.x/src/Tracy/Dumper' . '/assets/dumper-light.css')
			. file_get_contents('/var/www/html/httpdocs/site/modules/TracyDebugger/tracy-2.10.x/src/Tracy/Dumper' . '/assets/dumper-dark.css');
		echo "<style{$nonceAttr}>", str_replace('</', '<\/', Helpers::minifyCss($s)), "</style>\n";

		if (!Debugger::isEnabled()) {
			$s = '(function(){' . file_get_contents('/var/www/html/httpdocs/site/modules/TracyDebugger/tracy-2.10.x/src/Tracy/Dumper' . '/../assets/toggle.js') . '})();'
				. '(function(){' . file_get_contents('/var/www/html/httpdocs/site/modules/TracyDebugger/tracy-2.10.x/src/Tracy/Dumper' . '/../Dumper/assets/dumper.js') . '})();';
